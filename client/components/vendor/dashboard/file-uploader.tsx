...
export function FileUploader({ value, onChange, accept='*', maxSize = 5, helperText,error }: FileUploaderProps) {
  ...
  return (
    <div className="space-y-2">
      ...
      >
        ...
        {value? (
          <div className="py-2">
            <p className="text-sm font-medium mb-1">File uploaded successfully</p>4
            {accept?.includes('image') && value.startsWith('data:image') && (
               <div className="flex justify-center mt-2">
               <img src={value} alt="Preview" className="max-h-24 max-w-full rounded" />
             </div>
            )}
            <Button
             variant="outline"
